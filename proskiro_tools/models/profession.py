...
# Each group has: label, slug, description, icon (SVG path), color, bg_color
ISCO_GROUPS = {
    "0": {
        "label": "Armed Forces",
        "slug": "armed-forces",
        "description": "Military occupations including commissioned officers, non-commissioned officers, and other ranks in the armed forces.",
    ...
    "1": {
        "label": "Managers",
        "slug": "managers",
        "description": "Senior officials, chief executives, and managers across business, retail, hospitality, and specialised services.",
    ...
    "2": {
        "label": "Professionals",
        "slug": "professionals",
        "description": "Science, engineering, health, teaching, business, ICT, and legal professionals requiring advanced education and expertise.",
    ...
    "3": {
        "label": "Technicians",
        "slug": "technicians",
        "description": "Associate professionals and technicians in science, engineering, health, business, ICT, and related fields.",
    ...
    "4": {
        ...
        "description": "General clerks, keyboard operators, customer service, and numerical and material recording workers.",
    ...
    "5": {
        ...
        "description": "Personal service workers, sales workers, personal care workers, and protective services workers.",
    ...
    "6": {
        ...
        "description": "Skilled agricultural, forestry, and fishery workers including market-oriented and subsistence farming.",
    ...
    "7": {
        ...
        "description": "Building, metal, machinery, handicraft, electrical, electronic, and food-related trades workers.",
    ...
    "8": {
        ...
        "description": "Stationary plant and machine operators, assemblers, and drivers and mobile plant operators.",
    ...
    "9": {
        ...
        "description": "Cleaners, helpers, labourers, food preparation assistants, and street service workers.",
...
ISCO_SUBGROUPS = {
    ...
    "01": {
        ...
        "slug": "commissioned-armed-forces-officers",
    ...
    "02": {
        ...
        "slug": "non-commissioned-armed-forces-officers",
        "icon": "M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z",
        "color": "#1d4ed8",
        "bg_color": "#dbeafe",
    },
    ...
    "11": {
        ...
        "slug": "chief-executives-and-legislators",
    ...
    "12": {
        ...
        "slug": "administrative-and-commercial-managers",
        "icon": "M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z",
        "color": "#7c3aed",
        "bg_color": "#ede9fe",
    },
    "13": {
        ...
        "slug": "production-and-specialised-services-managers",
    ...
    "14": {
        ...
        "slug": "hospitality-and-retail-managers",
    ...
    "21": {
        ...
        "slug": "science-and-engineering-professionals",
    ...
    "24": {
        ...
        "slug": "business-and-administration-professionals",
    ...
    "26": {
        ...
        "slug": "legal-social-and-cultural-professionals",
    ...
    "31": {
        ...
        "slug": "science-and-engineering-technicians",
        "icon": "M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 004.486-6.336l-3.276 3.277a3.004 3.004 0 01-2.25-2.25l3.276-3.276a4.5 4.5 0 00-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437l1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008z",
        "color": "#c2410c",
        "bg_color": "#ffedd5",
    },
    "32": {
        ...
        "slug": "health-associate-professionals",
    ...
    "33": {
        ...
        "slug": "business-and-administration-technicians",
    ...
    "34": {
        ...
        "slug": "legal-social-and-cultural-technicians",
    ...
    "41": {
        ...
        "slug": "general-and-keyboard-clerks",
        "icon": "M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25zM6.75 12h.008v.008H6.75V12zm0 3h.008v.008H6.75V15zm0 3h.008v.008H6.75V18z",
        "color": "#4338ca",
        "bg_color": "#e0e7ff",
    },
    ...
    "43": {
        ...
        "slug": "numerical-and-material-recording-clerks",
    ...
    "44": {
        ...
        "slug": "other-clerical-support-workers",
    ...
    "54": {
        ...
        "slug": "protective-services-workers",
        "icon": "M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z",
        "color": "#9f1239",
        "bg_color": "#fff1f2",
    },
    ...
    "61": {
        ...
        "slug": "skilled-agricultural-workers",
        "icon": "M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z",
        "color": "#4d7c0f",
        "bg_color": "#ecfccb",
    },
    "62": {
        ...
        "slug": "skilled-forestry-and-fishery-workers",
    ...
    "63": {
        ...
        "slug": "subsistence-farmers-and-fishers",
    ...
    "71": {
        ...
        "slug": "building-and-related-trades-workers",
    ...
    "72": {
        ...
        "slug": "metal-and-machinery-trades-workers",
        "icon": "M21.75 6.75a4.5 4.5 0 01-4.884 4.484c-1.076-.091-2.264.071-2.95.904l-7.152 8.684a2.548 2.548 0 11-3.586-3.586l8.684-7.152c.833-.686.995-1.874.904-2.95a4.5 4.5 0 016.336-4.486l-3.276 3.276a3.004 3.004 0 002.25 2.25l3.276-3.276c.256.565.398 1.192.398 1.852z",
        "color": "#b45309",
        "bg_color": "#fef3c7",
    },
    "73": {
        ...
        "slug": "handicraft-and-printing-workers",
    ...
    "74": {
        ...
        "slug": "electrical-and-electronic-trades-workers",
    ...
    "75": {
        ...
        "slug": "food-wood-and-garment-trades-workers",
    ...
    "81": {
        ...
        "slug": "stationary-plant-and-machine-operators",
        "icon": "M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l1.41-.513M5.106 17.785l1.15-.964m11.49-9.642l1.149-.964M7.501 19.795l.75-1.3m7.5-12.99l.75-1.3m-6.063 16.658l.26-1.477m2.605-14.772l.26-1.477m0 17.726l-.26-1.477M10.698 4.614l-.26-1.477M16.5 19.794l-.75-1.299M7.5 4.205L12 12m6.894 5.785l-1.149-.964M6.256 7.178l-1.15-.964m15.352 8.864l-1.41-.513M4.954 9.435l-1.41-.514M12.002 12l-3.75 6.495",
        "color": "#0e7490",
        "bg_color": "#cffafe",
    },
    ...
    "83": {
        ...
        "slug": "drivers-and-mobile-plant-operators",
    ...
    "92": {
        ...
        "slug": "agricultural-and-forestry-labourers",
        "icon": "M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z",
        "color": "#db2777",
        "bg_color": "#fce7f3",
    },
    "93": {
        ...
        "slug": "labourers-mining-construction-transport",
    ...
    "94": {
        ...
        "slug": "food-preparation-assistants",
        "icon": "M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546 5.974 5.974 0 01-2.133-1A3.75 3.75 0 0012 18z",
        "color": "#f472b6",
        "bg_color": "#fdf2f8",
    },
    "95": {
        ...
        "slug": "street-sales-and-service-workers",
        "icon": "M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zM12 2.25V4.5m5.834.166l-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243l-1.59-1.59",
        "color": "#be185d",
        "bg_color": "#fce7f3",
    },
    "96": {
        ...
        "slug": "refuse-and-other-elementary-workers",
...
# --- Slug lookup helpers for group pages ---

# Build reverse slug → code maps at module load time
_GROUP_SLUG_TO_CODE: dict[str, str] = {
    v["slug"]: k for k, v in ISCO_GROUPS.items()
}
_SUBGROUP_SLUG_TO_CODE: dict[str, str] = {
    v["slug"]: k for k, v in ISCO_SUBGROUPS.items()
}


def get_group_by_slug(slug: str) -> tuple[str, dict] | None:
    """Look up a major group by its URL slug.

    Returns (code, group_dict) or None if not found.
    """
    code = _GROUP_SLUG_TO_CODE.get(slug)
    if code is None:
        return None
    return code, ISCO_GROUPS[code]


def get_subgroup_by_slug(slug: str) -> tuple[str, dict] | None:
    """Look up a sub-major group by its URL slug.

    Returns (code, subgroup_dict) or None if not found.
    """
    code = _SUBGROUP_SLUG_TO_CODE.get(slug)
    if code is None:
        return None
    return code, ISCO_SUBGROUPS[code]


def get_subgroups_for_group(group_code: str) -> list[tuple[str, dict]]:
    """Return all sub-major groups belonging to a major group.

    Args:
        group_code: 1-digit major group code (e.g. "2")

    Returns:
        List of (code, subgroup_dict) tuples sorted by code
    """
    return [
        (code, sg)
        for code, sg in sorted(ISCO_SUBGROUPS.items())
